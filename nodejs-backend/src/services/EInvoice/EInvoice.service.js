const { EInvoice } = require("./EInvoice.class");
const createModel = require("../../models/EInvoice.model");
const hooks = require("./EInvoice.hooks");
...
module.exports = function (app) {
  ...
  app.use("/EInvoice", new EInvoice(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("EInvoice");

  // Get the schema of the collections 
  app.get("/EInvoiceSchema", function (request, response) {
