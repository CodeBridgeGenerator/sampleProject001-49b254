...
const CustomerDetailsFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        ...
        setLoading(true);
        const promises = fakeData.map((elem) => client.service("customerDetails").create(elem));
...
export default connect(mapState, mapDispatch)(CustomerDetailsFakerDialogComponent);
