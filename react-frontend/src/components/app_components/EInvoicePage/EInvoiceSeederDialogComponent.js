...
import seederData from "./EInvoice.seeder.json";
...
const EInvoiceSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EInvoiceSeederDialogComponent);
