...
const EInvoiceDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
  ...
  const handleHideDialog = () => {
    ...
    return (
      ...
      {selectedItems.length > 0 ? (
        ...
        <Dialog header="Upload EInvoice Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService 
          user={user} 
      ...
      <Dialog header="Search EInvoice" visible={searchDialog} onHide={() => setSearchDialog(false)}>
      Search
    </Dialog>
    <Dialog
        header="Filter Users"
...
export default EInvoiceDataTable;